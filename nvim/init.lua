...
--
--    Based on the amazing kickstart.nvim project. For more details visit
...
require('lazy').setup({
  ...
  -- Remove extrawhitespace from files on save
  {
    "cappyzawa/trim.nvim",
    opts = {}
  },

  -- Add slim template syntax highlighting
  "slim-template/vim-slim",

  -- Add coffeescript syntax highlighting
  "kchmck/vim-coffee-script",

  -- Add the awesome tpope surround plugin
  "tpope/vim-surround",

  -- Add NerdTree and related packages
  {
    'preservim/nerdtree',
    config = function ()
...
-- Add visual line length colums
vim.o.colorcolumn = '+1,+5'

-- Set text width
vim.o.textwidth = 80

-- Set scroll offset when moving around a file
vim.o.scrolloff = 5
...
-- Configure NERDTree
vim.keymap.set('n', '<Leader>n', 'g:NERDTree.IsOpen() ? ":NERDTreeClose<cr>" : @% == "" ? ":NERDTree<cr>" : ":NERDTreeFind<cr>"', { expr = true, noremap = true })
...
-- Manual LSP Server initialization
